...
@interface PREThemeMainViewSettingsWhite()
...
@implementation PREThemeMainViewSettingsWhite

- (id)init
{
    self = [super init];
    if (self) {
        self.name = @"White Views Settings";
    }
    return self;
}
...
- (void)initializeColorsWithNullify:(BOOL)isNullify
{
    ...
    self.titleTextColor = isNullify ? nil : [PREColor corporateLimeadeGreen];
    ...
    self.actionColor = isNullify ? nil : [PREColor corporateLimeadeGreen];
    self.statusBarStyle = UIStatusBarStyleDefault;
    self.navigationBarTintColor = [PREColor corporateSnowFlurryGreen];
...
#pragma mark - NATIVE UIKIT VIEWS
    ...
    [[UINavigationBar appearance] setTintColor:self.actionColor];
    ...
    if (@available(iOS 11.0, *))
        [[UINavigationBar appearance] setLargeTitleTextAttributes:@{NSForegroundColorAttributeName:self.actionColor?:self.DEFAULT_COLOR}];
    [[UIButton appearanceWhenContainedInInstancesOfClasses:@[[UINavigationBar class]]] setTintColor:self.actionColor];
    ...
    [[UIToolbar appearance] setBarTintColor:self.navigationBarTintColor];
...
#pragma mark - CUSTOM UIKIT VIEWS
    ...
    //  ---------------------------
    [[PRENameValuePairStackView appearance] setTitleTextColor:[PREColor corporateVidaLocaGreen]];
...
#pragma mark - TABLE & COLLECTION VIEW CELLS
    ...
    //    [[UIImageView appearanceWhenContainedInInstancesOfClasses:@[[ConnectionEntityTableViewCell class]]] setTintColor:[PREColor gray90Color]];
    ...
    [[NewEventCell appearance] setEditModeBookmarkedTextColor:[PREColor corporateVidaLocaGreen]];
    [[NewEventCell appearance] setEditModeNotBookmarkedTextColor:self.descriptionTextColor];
    
    // ---------------------------
    [[EventSessionCell appearance] setEditModeBookmarkedTextColor:[PREColor corporateVidaLocaGreen]];
...
#pragma mark - VIEW CONTROLLERS
    ...
    [[PREParentBaseViewController appearance] setNavigationSearchBarBorderColor:[PREColor gray50Color]];
    [[PREParentBaseViewController appearance] setNavigationSearchBarButtonTintColor:[PREColor corporateVidaLocaGreen]];
    ...
    [[LoginScreenVC appearance] setLoginButtonBackgroundColor:[PREColor corporateVidaLocaGreen]];
    ...
    [[NewCredentialEditor appearance] setSaveAndLaunchButtonBgColor:[PREColor corporateVidaLocaGreen]];
    [[NewCredentialEditor appearance] setSaveButtonBgColor:[PREColor corporateVidaLocaGreen]];
...
#pragma mark - TABLE VIEW HEADERS
    ...
    // ---------------------------
    [[PREMoneyHeader appearance] setBaseColor:[PREColor corporateLimeadeGreen]];
...
#pragma mark - TABLE VIEW SECTIONS
    ...
    //  ---------------------------
    [[PREParentBaseTableViewSectionView appearance] setBaseColor:(PREColor *)[PREColor groupTableViewBackgroundColor]];
    ...
    //  ---------------------------
    [[PREMoneySection appearance] setBaseColor:[PREColor corporateLimeGreen]];
    [[PREMoneySection appearance] setTopSeparatorColor:[PREColor corporateVidaLocaGreen]];
    ...
    // ---------------------------
    [[PREResultsFooter appearance] setBaseColor:[PREColor corporateLimeadeGreen]];
